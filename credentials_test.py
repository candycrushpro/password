...
class TestCredentials(unittest.TestCase):
    ...
    def test_credentials_instance(self):
        ...
        '''
        self.assertEqual(self.new_credentials.account_name,"Kijakazi")
        self.assertEqual(self.new_credentials.account_password,"6702")
    ...
    def test_delete_credentials(self):
        '''
        test delete credentials to test if we can remove an account from our list
        '''

        self.new_credentials.save_credentials()
        test_credentials = Credentials("Kijakazi","6702")
